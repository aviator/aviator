...
class Aviator::Test
  ...
  describe 'aviator/providers/openstack/compute/v2/public/create_image' do

    def create_request(session_data = get_session_data, &block)
      block ||= lambda do |params|
                  params[:id]   = 0
                  params[:name] = 'thisdoesnotmatter'
                end
    ...
    def klass
      @klass ||= helper.load_request('openstack', 'compute', 'v2', 'public', 'create_image.rb')
    end
