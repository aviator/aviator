...
class Aviator::Test
  ...
  describe 'aviator/providers/openstack/compute/v2/public/delete_image' do
    ...
    def klass
      @klass ||= helper.load_request('openstack', 'compute', 'v2', 'public', 'delete_image.rb')
    end
    ...
    validate_response 'valid params are provided' do
      ...
      response = session.compute_service.request :delete_image do |params|
        params[:id] = image_id
      end
