...
class Aviator::Test
  ...
  describe 'aviator/providers/openstack/volume/v1/public/root' do
    ...
    def klass
      @klass ||= helper.load_request('openstack', 'volume', 'v1', 'public', 'root.rb')
    end
    ...
    validate_response 'no parameters are provided' do
      response = session.volume_service.request :root
