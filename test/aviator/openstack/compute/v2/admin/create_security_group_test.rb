...
class Aviator::Test
  ...
  describe 'aviator/openstack/compute/v2/admin/create_security_group' do
    ...
    def klass
      @klass ||= helper.load_request('openstack', 'compute', 'v2', 'admin', 'create_security_group.rb')
    end
    ...
    validate_attr :url do
      ...
      url          = "#{ service_spec[:endpoints][0][:adminURL] }/os-security-groups"
