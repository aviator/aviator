...
class Aviator::Test
  ...
  describe 'aviator/openstack/compute/v3/admin/get_default_quotas' do
    ...
    def klass
      @klass ||= helper.load_request('openstack', 'compute', 'v3', 'admin', 'get_default_quotas.rb')
    end
    ...
    validate_response 'a valid param is provided' do
      ...
      response = session.compute_service.request(:get_default_quotas, base_url: v3_base_url) do |params|
